...
6. **The `billing_status = null` clear after a successful manual charge (admin line 9715)** is standalone and fine — it's a single field cleanup after an already-successful Stripe call. Not worth RPC-ing.
