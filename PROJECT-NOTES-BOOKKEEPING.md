...
Commits: `c069722` (server generalization), `ced9526` (batch dropzone client, +778 lines), `557830e` (QA fix), `de45fad` + `934b0b4` (acceptance-test fixes). Edge function: loan-document-intake v4 → v5.
