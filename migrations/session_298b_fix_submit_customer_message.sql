-- Session 298b: submit_customer_message used an unassigned RECORD for the optional order
-- ("record v_order is not assigned yet" on general feedback). Scalars instead. Same signature/defaults.
